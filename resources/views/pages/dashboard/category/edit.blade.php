                ...
                <form action="{{route('dashboard.category.update', $item->id)}}" method="POST" enctype="multipart/form-data" class="w-full">
                    ...
                    <div class="flex flex-wrap mb-6 mx-3">
                        <div class="w-full px-3">
                            ...
                            <input type="text" name="name" placeholder="Category Name" id="grid-last-name" value="{{old('name') ?? $item->name}}" class="appearance-none block m-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                        </div>
                    </div>
